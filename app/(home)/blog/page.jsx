  ...
  const posts = [
    {
      ...
      excerpt:
        "Weather patterns have a profound impact on global food prices. Climate change exacerbates these issues, making weather patterns more unpredictable.",
    ...
    },
    {
      ...
      excerpt:
        "Grocery shopping can be expensive, but with a few smart strategies, you can save money without sacrificing quality.",
      date: "October 8, 2023",
      readTime: "8 min read",
      image:
    ...
    },
    {
      ...
      excerpt:
        "Plant-based diets have surged in popularity, driven by growing awareness of health, environmental, and ethical concerns.",
    ...
    },
    {
      ...
      excerpt:
        "Sustainable farming practices are crucial for preserving natural resources and ensuring long-term food security.",
      date: "November 2, 2023",
      readTime: "6 min read",
      image:
        "https://images.unsplash.com/photo-1504593811423-6dd665756598?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=320&q=80",
    ...
    },
    {
      ...
      excerpt:
        "Reducing food waste not only helps the environment but also saves money on groceries. Learn practical ways to minimize waste.",
      date: "November 5, 2023",
      readTime: "5 min read",
      image:
        "https://images.unsplash.com/photo-1512621776951-a57141f2eefd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=320&q=80",
      author: "Sophia White",
    ...
    },
    {
      ...
      excerpt:
        "Technology is revolutionizing food production, improving efficiency and sustainability across the agricultural sector.",
      ...
      <div className="relative bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="max-w-[85rem] mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              <span className="inline-block px-3 py-1 text-xs font-medium bg-green-800 bg-opacity-30 rounded-full mt-8 md:mt-7  mb-4">
                Featured Post
              </span>
          ...
          <div className="grid md:grid-cols-2">
            <div className="p-8 md:p-12">
              ...
              <p className="text-gray-300 mb-6">
                Get the latest articles, tips, and food industry insights
